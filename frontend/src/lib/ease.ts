// Shared motion tokens (from beui). Easing curves and springs used across the
// installed components - kept as their own module so a component update stays a
// straight copy.
